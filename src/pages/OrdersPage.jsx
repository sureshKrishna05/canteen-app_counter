...
const STATUS_STYLE = {
  paid:    { background: "#FEFCE8", color: "#A16207", border: "1px solid #FDE047" },
  created: { background: "#F3F4F6", color: "#4B5563", border: "1px solid #E5E7EB" },
};
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .accept-btn:hover { background: linear-gradient(135deg,#16a34a,#15803d) !important; }
        .reject-btn:hover { background: #FEE2E2 !important; color: #B91C1C !important; }
      `}</style>
      ...
      <div style={{
        ...
        <div style={{
          position: "absolute", bottom: -35, left: "36%",
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "1rem 2rem", position: "relative" }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <div style={{
                width: 56, height: 56,
                background: "linear-gradient(135deg, rgba(165,180,252,0.28), rgba(196,181,253,0.15))",
                ...
                flexShrink: 0,
                animation: orders.length > 0 ? "bounce-subtle 2s ease-in-out infinite" : "none",
              }}>
                📦
              </div>
              <div>
            ...
            <div style={{
              ...
              border: `1px solid ${orders.length > 0 ? "rgba(250,204,21,0.35)" : "rgba(165,180,252,0.25)"}`,
              borderRadius: 99,
              padding: "7px 16px",
              backdropFilter: "blur(6px)",
              transition: "all 0.3s",
              ...
              <span style={{ position: "relative", display: "inline-flex", width: 10, height: 10 }}>
                <span style={{
                  position: "absolute", inset: 0,
                  borderRadius: "50%",
                  background: orders.length > 0 ? "#facc15" : "#a5b4fc",
                  animation: orders.length > 0 ? "ping 1.2s ease-out infinite" : "none",
                }} />
                <span style={{
                  position: "relative",
                  ...
                  boxShadow: orders.length > 0
                    ...
                    : "0 0 6px rgba(165,180,252,0.6)",
                  display: "inline-block",
                }} />
              </span>
              <span style={{
                fontSize: 12, fontWeight: 700,
                color: orders.length > 0 ? "#facc15" : "#a5b4fc",
                letterSpacing: "0.08em",
                textTransform: "uppercase",
              }}>
                {orders.length > 0 ? `${orders.length} Pending` : "All Clear"}
              </span>
            </div>
          </div>
        </div>
      ...
      {selectedOrder && (
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 12, color: "#D1D5DB", margin: "0 0 1.25rem" }}>
            ...
            <div style={{ display: "flex", gap: 10, marginTop: "1.25rem" }}>
              ...
              <button
                ...
                style={{
                  ...
                  cursor: actionLoading ? "not-allowed" : "pointer",
                  fontFamily: "inherit",
                  boxShadow: actionLoading ? "none" : "0 2px 10px rgba(34,197,94,0.35)",
                  transition: "all 0.15s",
                }}
              >
